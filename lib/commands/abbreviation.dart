...
class AbbreviationCommand extends NomacSlashCommand {
  ...
  Future<void> _get(SlashCommandInteractionEvent event) async {
    ...
    if (key.isEmpty) {
      return await event.respond(MessageBuilder.content("Could not find the abbreviation provided"));
    }
  ...
  Future<void> _list(InteractionEvent event) async {
    return await event.respond(MessageBuilder.content("<https://www.reddit.com/r/Dreamtheater/wiki/index/songabbs>"));
  }
}
