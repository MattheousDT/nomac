...
export default new SlashCommandBuilder()
  ...
  .addSubcommand((option) =>
    option
      ...
      .addStringOption((str) =>
        str.setName("username").setDescription("Last.fm username. Defaults to the one specified in /fm save")
      )
  )
  .addSubcommand((option) =>
    option
  ...
  .addSubcommand((option) =>
    option
      ...
      .addStringOption((str) => str.setName("username").setDescription("Last.fm username").setRequired(true))
  );
...
export const fmRecent = async (interaction: CommandInteraction) => {
  ...
  try {
    ...
    return interaction.reply({ content: `No tracks found for ${username}`, ephemeral: true });
  }
};
...
export const fmArtists = async (interaction: CommandInteraction) => {
  ...
  try {
    ...
    return interaction.reply({ content: `An error occured or no artists found for ${username}`, ephemeral: true });
  }
};
...
export const fmCollage = async (interaction: CommandInteraction) => {
  ...
  try {
    ...
    return interaction.reply({ content: `An error occured or no data was found for ${username}`, ephemeral: true });
  }
};
...
export const fmSave = async (interaction: CommandInteraction) => {
  ...
  try {
    ...
    return interaction.reply({ content: `Your username has been set to ${username}`, ephemeral: true });
  } catch (error) {
